...
namespace CompVault.Backend.Migrations
{
    ...
    [Migration("20260415100451_RemoveDocumentSignatureAcknowledgement")]
    partial class RemoveDocumentSignatureAcknowledgement
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CompVault.Backend.Domain.Entities.Documents.Document", b =>
                {
                    ...
                    b.Property<Guid?>("TargetJobTitleId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CompVault.Backend.Domain.Entities.Documents.Document", b =>
                {
                    ...
                    b.HasOne("CompVault.Backend.Domain.Entities.JobTitles.JobTitle", "TargetJobTitle")
                        .WithMany("Documents")
                        .HasForeignKey("TargetJobTitleId")
                        .OnDelete(DeleteBehavior.Restrict);
