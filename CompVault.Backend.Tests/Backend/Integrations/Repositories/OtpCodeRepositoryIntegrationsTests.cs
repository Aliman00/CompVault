    ...
    BackendWebApplicationFactory factory) : IAsyncLifetime
{
    ...
    /// <summary>
    /// Tester at vi returnerer kun den aktive koden når brukeren har flere koder - en aktiv og en inaktiv kode
    /// </summary>
    [Fact]
    ...
    public async Task GenerateOtpCodeAsync_ConcurrentRequests_OnlyOneSucceeds()
    {
        ...
        Task<Result<string>> task1 = Task.Run(async () =>
        {
            barrier.SignalAndWait();
            return await sut1.GenerateOtpCodeAsync(TestConstants.Users.ActiveUserId);
        });

        Task<Result<string>> task2 = Task.Run(async () =>
        {
            barrier.SignalAndWait();
    ...
    /// </summary>
    [Fact]
    public async Task DeleteInactiveForUserAsync_ExpiredCode_DeletesCode()
    {
        // Arrange - oppretter utgått token
        OtpCode expiredCode = await TestDataSeeder.SeedOtpCodeAsync(factory.Services,
            userId: TestConstants.Users.ActiveUserId,
        ...
        // Act
        await _sut.DeleteInactiveForUserAsync(TestConstants.Users.ActiveUserId, CancellationToken.None);
    ...
    /// </summary>
    [Fact]
    public async Task DeleteInactiveForUserAsync_UsedCode_DeletesCode()
    {
        // Arrange
    ...
    /// </summary>
    [Fact]
    public async Task DeleteInactiveForUserAsync_ActiveCode_DoesNotDeleteCode()
    {
        // Arrange
        OtpCode activeCode = await TestDataSeeder.SeedOtpCodeAsync(factory.Services,
            userId: TestConstants.Users.ActiveUserId);
    ...
    /// </summary>
    [Fact]
    public async Task DeleteInactiveForUserAsync_ExpiredCodeForOtherUser_DoesNotDeleteCode()
    {
